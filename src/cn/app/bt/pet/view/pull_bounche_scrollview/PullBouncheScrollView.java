...
import cn.app.bt.pet.view.pull_listview.PullListView.AnimatorListenerNullImpl;

public class PullBouncheScrollView extends ScrollView {
	...
	public PullBouncheScrollView(Context context) {
		super(context);
	}

	public PullBouncheScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
